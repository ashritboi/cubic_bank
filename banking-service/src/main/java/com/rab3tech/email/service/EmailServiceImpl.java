...
public class EmailServiceImpl implements EmailService{
	...
	@Override
	@Async("threadPool")
	public String sendCheckRequestEmail(EmailVO mail)  {
		 ...
		 try {
	        ...
	        Map<String,Object> props=new HashMap<>();
	        props.put("name", mail.getName());
	        //props.put("referenceNumber", mail.getRefNo());
	        props.put("sign", "Banking Application");
	        props.put("location", "dallas CA100 , USA");
	        props.put("email", "ashritboi@gmail.com");
	        props.put("address", "4016 N Story Road, Irving, Tx , USA");
	        context.setVariables(props);
	        String html = templateEngine.process("check-request-email-template", context);
	        helper.setTo(mail.getTo());
	        helper.setText(html, true);
	        helper.setSubject(mail.getSubject());
	        helper.setFrom(mail.getFrom());
