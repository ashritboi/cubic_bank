...
public class CustomerServiceImpl implements  CustomerService{
	...
	@Autowired
	private CustomerQuestionsAnsRepository customerQuestionAnswerRepository;
	...
	@Override
	public CustomerVO editAccount(String email) {
	...
	public void update(CustomerVO customerVO) {
		...
		Utils.copyNonNullProperties(customerVO, customer);
		customerRepository.save(customer);
//		List<CustomerQuestionAnswer>customerQuestionAnswers = customerQuestionAnswerRepository.findQuestionAnswer(customerVO.getEmail());
